...
public class DatePeriodUtil {
    ...
    public static boolean areOverlapping(DatePeriod period1, DatePeriod period2) {
        return ( (period1.getStart().isBefore(period2.getStart()) || period1.getStart().isEqual(period2.getStart())) && 
        		 (isInPeriod(period1.getEnd(), period2) || period1.getEnd().isAfter(period2.getEnd()))) ||
               ( (isInPeriod(period1.getStart(), period2) || period1.getStart().isBefore(period2.getStart())) && 
            	 (period1.getStart().isAfter(period2.getStart()) || period1.getStart().isEqual(period2.getStart())) );
    }
